...
)
{
	...
	odm_set_bb_reg(dm, R_0xcd4, 0xFFF000, 0x100);  /* �Ncd4[23:12] �令 h'100, �䥦�줸�ЫO�d��Ȥ��n�g��
     * �`�Npage c1��c90�bDPK�L�{���d�U����Q��Lthread or process��g��page c��c90�� */
	odm_write_4byte(dm, 0xc90, 0x0101f018);
...
)
{
	...
	cali_info->dpk_thermal[RF_PATH_A] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Ū�X42[15:10] �Ȩæs���ܼ�TMeter */
...
)
{
	...
	odm_set_bb_reg(dm, R_0xed4, 0xFFF000, 0x100);  /* �Ncd4[23:12] �令 h'100, �䥦�줸�ЫO�d��Ȥ��n�g��
     * �`�Npage c1��c90�bDPK�L�{���d�U����Q��Lthread or process��g��page c��c90�� */
	odm_write_4byte(dm, 0xe90, 0x0101f018);
...
)
{
	...
	/* T-meter RFReg42[17] = 1 to enable read T-meter, [15:10] ' T-meter value */
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x42, BIT(17), 1);
	cali_info->dpk_thermal[RF_PATH_B] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Ū�X42[15:10] �Ȩæs���ܼ�TMeter */
